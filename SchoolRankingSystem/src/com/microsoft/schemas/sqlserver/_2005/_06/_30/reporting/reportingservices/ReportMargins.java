...
public class ReportMargins implements java.io.Serializable {
	...
	public ReportMargins(double top, double bottom, double left, double right) {
		this.top = top;
		this.bottom = bottom;
		this.left = left;
		this.right = right;
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ReportMargins))
			return false;
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && this.top == other.getTop()
