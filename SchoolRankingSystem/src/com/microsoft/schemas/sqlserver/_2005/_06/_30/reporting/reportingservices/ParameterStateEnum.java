...
public class ParameterStateEnum implements java.io.Serializable {
	...
	public static final ParameterStateEnum HasValidValue = new ParameterStateEnum(
			_HasValidValue);
	public static final ParameterStateEnum MissingValidValue = new ParameterStateEnum(
			_MissingValidValue);
	public static final ParameterStateEnum HasOutstandingDependencies = new ParameterStateEnum(
			_HasOutstandingDependencies);
	public static final ParameterStateEnum DynamicValuesUnavailable = new ParameterStateEnum(
			_DynamicValuesUnavailable);
	...
	public static ParameterStateEnum fromValue(java.lang.String value)
		...
		ParameterStateEnum enumeration = (ParameterStateEnum) _table_
				.get(value);
		if (enumeration == null)
