...
public class ExtensionTypeEnum implements java.io.Serializable {
	...
	public static final ExtensionTypeEnum Delivery = new ExtensionTypeEnum(
			_Delivery);
	public static final ExtensionTypeEnum Render = new ExtensionTypeEnum(
			_Render);
	...
	public static ExtensionTypeEnum fromValue(java.lang.String value)
		...
		ExtensionTypeEnum enumeration = (ExtensionTypeEnum) _table_.get(value);
		if (enumeration == null)
