...
public class SortDirectionEnum implements java.io.Serializable {
	...
	public static final SortDirectionEnum Ascending = new SortDirectionEnum(
			_Ascending);
	public static final SortDirectionEnum Descending = new SortDirectionEnum(
			_Descending);
	...
	public static SortDirectionEnum fromValue(java.lang.String value)
		...
		SortDirectionEnum enumeration = (SortDirectionEnum) _table_.get(value);
		if (enumeration == null)
