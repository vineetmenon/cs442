...
public class Extension implements java.io.Serializable {
	...
	public Extension(
			...
			java.lang.String name, java.lang.String localizedName,
			boolean visible, boolean isModelGenerationSupported) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		boolean _equals;
		_equals = true
				&& ((this.extensionType == null && other.getExtensionType() == null) || (this.extensionType != null && this.extensionType
						.equals(other.getExtensionType())))
				&& ((this.name == null && other.getName() == null) || (this.name != null && this.name
						.equals(other.getName())))
				&& ((this.localizedName == null && other.getLocalizedName() == null) || (this.localizedName != null && this.localizedName
						.equals(other.getLocalizedName())))
				&& this.visible == other.isVisible()
				&& this.isModelGenerationSupported == other
						.isIsModelGenerationSupported();
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		_hashCode += (isIsModelGenerationSupported() ? Boolean.TRUE
